...
// Flatten top keywords for root metadata
const rootKeywords = [
  ...SEO_KEYWORDS.brand,
  ...SEO_KEYWORDS.transactional.slice(0, 8),
  ...SEO_KEYWORDS.informational.slice(0, 6),
...
export const metadata: Metadata = {
  ...
  title: {
    default: `${SITE_NAME} - AI-Powered Freelance Marketplace | Hire Top Developers, Designers & More`,
  ...
  openGraph: {
    ...
    url: BASE_URL,
    siteName: SITE_NAME,
    title: `${SITE_NAME} - AI-Powered Freelance Marketplace | Hire Top Talent`,
    description: 'Connect with world-class freelancers and clients. AI-powered matching, secure blockchain payments, real-time collaboration. Zero fees for freelancers. The best Upwork & Fiverr alternative.',
  ...
  twitter: {
    ...
    site: '@megilance',
    creator: '@megilance',
    title: `${SITE_NAME} - AI-Powered Freelance Marketplace`,
    description: 'Hire top freelancers or find freelance work. AI matching, blockchain payments, zero fees. The future of freelancing.',
