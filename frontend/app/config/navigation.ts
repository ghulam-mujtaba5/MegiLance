...
export const freelancerNavItems: NavItem[] = [
  ...
  { label: 'Portfolio', href: '/freelancer/portfolio', icon: 'User', section: 'Profile & Growth' },
...
export const clientNavItems: NavItem[] = [
  ...
  { label: 'Analytics', href: '/client/analytics', icon: 'LineChart', section: 'Insights' },
  { label: 'Video Calls', href: '/client/video-calls', icon: 'Video' },
...
export const adminNavItems: NavItem[] = [
  ...
  { label: 'Feedback', href: '/admin/feedback', icon: 'Mail' },
  { label: 'Video Calls', href: '/admin/video-calls', icon: 'Video' },
  { label: 'Support', href: '/admin/support', icon: 'HelpCircle', section: 'Settings' },
