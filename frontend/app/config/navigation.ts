...
export const freelancerNavItems: NavItem[] = [
  ...
  { label: 'Time Tracking', href: '/portal/freelancer/time-tracking', icon: 'Calendar' },
  { label: 'Invoices', href: '/portal/freelancer/invoices', icon: 'FileText' },
  { label: 'Portfolio', href: '/freelancer/portfolio', icon: 'User' },
...
export const clientNavItems: NavItem[] = [
  ...
  { label: 'Post Job', href: '/client/post-job', icon: 'TrendingUp' },
  ...
  { label: 'Escrow', href: '/portal/client/escrow', icon: 'Lock' },
  { label: 'Refunds', href: '/portal/client/refunds', icon: 'History' },
  { label: 'Reviews', href: '/client/reviews', icon: 'Star' },
  { label: 'Wallet', href: '/client/wallet', icon: 'Wallet' },
  { label: 'Favorites', href: '/portal/favorites', icon: 'Heart' },
  { label: 'Support', href: '/portal/support', icon: 'HelpCircle' },
...
export const adminNavItems: NavItem[] = [
  ...
  { label: 'Tags', href: '/portal/admin/tags', icon: 'Tag' },
  { label: 'Categories', href: '/admin/categories', icon: 'List' },
  { label: 'Skills', href: '/admin/skills', icon: 'Wrench' },
  { label: 'Refunds', href: '/portal/admin/refunds', icon: 'History' },
  { label: 'Payments', href: '/admin/payments', icon: 'CreditCard' },
  { label: 'AI Monitoring', href: '/admin/ai-monitoring', icon: 'Bot' },
