// @AI-HINT: This file provides mock data for the MegiLance dashboard. Using realistic, externalized mock data is a best practice for developing premium SaaS applications, as it allows for independent testing and development of UI components without relying on live backend services.

import { DashboardMetric, RecentProject, ActivityFeedItem } from './types';
import { FaBriefcase, FaClipboardCheck, FaUsers, FaChartBar, FaCreditCard, FaTasks, FaUserClock, FaRocket } from 'react-icons/fa';

/**
 * Mock data for the key performance indicator (KPI) metrics.
 * Reflects typical data points for a high-end freelance and project management platform.
 */
...
/**
 * Mock data for the list of recent projects.
 * Includes various statuses to test UI states and component rendering.
 */
...
/**
 * Mock data for the user activity feed.
 * Simulates various types of platform notifications and events.
 */
