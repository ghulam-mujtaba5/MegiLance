// @AI-HINT: This API route serves support ticket data for the admin panel from a centralized JSON file.
...
export async function GET() {
  try {
    ...
    const filePath = path.join(jsonDirectory, 'admin_support_tickets.json');
