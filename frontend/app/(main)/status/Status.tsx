    ...
    <main className={cn(common.page, themed.themeWrapper)}>
      <div className={common.container}>
        ...
        <section className={common.section}>
          ...
          <div className={common.statusGrid}>
            <div className={cn(common.statusCard, common.operational)}>
        ...
        <section className={common.section}>
          ...
          <div className={common.incidentsList}>
            <div className={common.incidentCard}>
        ...
        <section className={common.section}>
          ...
          <div className={common.metricsGrid}>
            <div className={common.metricCard}>
