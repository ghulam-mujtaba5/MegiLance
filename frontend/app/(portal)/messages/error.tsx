// @AI-HINT: Error boundary for messages route
'use client';

import React, { useEffect } from 'react';
import { RefreshCw, ArrowLeft, MessageSquareWarning } from 'lucide-react';
      ...
      <div className="text-center max-w-lg space-y-5">
        <div className="flex justify-center">
          <div className="w-16 h-16 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
            <MessageSquareWarning className="w-8 h-8 text-blue-600 dark:text-blue-400" aria-hidden="true" />
          </div>
        </div>
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm max-w-sm mx-auto">
          Your messages are safe. This is a temporary connection issue.
        </p>
