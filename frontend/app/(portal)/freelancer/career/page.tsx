      ...
      <div className={cn(commonStyles.tabContent, themeStyles.tabContent)}>
        {activeTab === 'progress' && (
          <div className={cn(commonStyles.progressSection, themeStyles.progressSection)}>
            ...
            <div className={cn(commonStyles.skillsGrid, themeStyles.skillsGrid)}>
              {progress.map((skill) => (
                <Card key={skill.skill_id} className={cn(commonStyles.skillCard, themeStyles.skillCard)}>
        ...
        {activeTab === 'paths' && (
          <div className={cn(commonStyles.pathsGrid, themeStyles.pathsGrid)}>
            {paths.map((path) => (
              <Card key={path.id} className={cn(commonStyles.pathCard, themeStyles.pathCard)}>
        ...
        {activeTab === 'goals' && (
          <div className={cn(commonStyles.goalsSection, themeStyles.goalsSection)}>
            {goals.length === 0 ? (
              ...
              <div className={cn(commonStyles.goalsList, themeStyles.goalsList)}>
                {goals.map((goal) => (
                  <Card key={goal.id} className={cn(commonStyles.goalCard, themeStyles.goalCard)}>
        ...
        {activeTab === 'mentors' && (
          <div className={cn(commonStyles.mentorsSection, themeStyles.mentorsSection)}>
            <div className={cn(commonStyles.mentorsGrid, themeStyles.mentorsGrid)}>
              {mentors.map((mentor) => (
                <Card key={mentor.id} className={cn(commonStyles.mentorCard, themeStyles.mentorCard)}>
