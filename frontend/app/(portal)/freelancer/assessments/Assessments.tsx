...
const AssessmentsPage: React.FC = () => {
  ...
  return (
    <main className={cn(common.page, themed.page)}>
      ...
      {/* Assessments List */}
      {!loading && !error && (
        <div className={common.assessmentList}>
          {assessments.map((assessment) => (
            <div key={assessment.id} className={cn(common.assessmentCard, themed.assessmentCard)}>
              ...
              <div className={common.assessmentActions}>
                {assessment.completed ? (
                  ...
                  <Link href={`/freelancer/assessments/new?skillId=${assessment.id}&skillName=${encodeURIComponent(assessment.title)}`}>
                    <Button 
                      variant="primary" 
                      size="md" 
