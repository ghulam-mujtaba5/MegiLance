...
// @AI-HINT: This is a standardized, reusable Button component based on shadcn/ui.
// It uses class-variance-authority for different styles and is fully theme-aware.
