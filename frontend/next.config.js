...
const nextConfig = {
  // Next.js 16 uses Turbopack by default - disable it for better compatibility during build
  // Turbopack has issues resolving path aliases in Docker build environment
  experimental: {
    turbopack: false
  },
